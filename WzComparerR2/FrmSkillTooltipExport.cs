...
namespace WzComparerR2
{
    public partial class FrmSkillTooltipExport : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private static Dictionary<string, int[]> jobNameToCode = new Dictionary<string, int[]>()
        {
            ...
            // { "몬스터라이프", new int[] { 7200 } }, 
            // { "길드", new int[] { 9100 } }, 
            // { "전문기술", new int[] { 9200, 9201, 9202, 9203, 9204 } }, 
        ...
        private void btnSort_Click(object sender, EventArgs e)
        {
            ...
            this.btnSort.Text = this.sorted ? "가나다 순서" : "기본 순서";
            this.UpdateList();
        }
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBoxEx.Show("내보낼 직업을 선택하세요.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        private void UpdateList()
        {
            ...
            this.clbJobName.Items.Add("기타", checkedList.Contains("기타"));
            if (!this.sorted)
            {
