...
namespace WzComparerR2.DB2
{
    class DataViewer : DataGridView
    {
        ...
        public DataViewer(GridType gridType)
        {
            ...
            FamiliarSkillName.HeaderText = "스킬";
            ...
            FamiliarSkillDesc.HeaderText = "스킬 설명";
            ...
            FamiliarCardID.HeaderText = "패밀리어 카드 ID";
