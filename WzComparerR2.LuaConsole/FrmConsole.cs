...
namespace WzComparerR2.LuaConsole
{
    public partial class FrmConsole : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void FrmConsole_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                if (DialogResult.Yes != MessageBoxEx.Show(this, "진행중인 작업이 있습니다. 종료하시겠습니까?", "경고", MessageBoxButtons.YesNo, MessageBoxIcon.Warning))
                {
                    e.Cancel = true;
                    return;
                }
        ...
        private void menuReset_Click(object sender, EventArgs e)
        {
            ...
            {
                ToastNotification.Show(this, "이전 작업을 진행중입니다.", 1000, eToastPosition.TopCenter);
                return;
            }
            ...
            {
                MessageBoxEx.Show(this, "현재 선택된 스크립트가 없습니다.", "오류", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            this.env.WriteLine("콘솔이 초기화되었습니다.");
        }
        ...
        private async void menuRun_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.env.WriteLine("실행: {0}...", selectedEditor.BaseFileName);
        ...
        private void menuStopRun_Click(object sender, EventArgs e)
        {
            ...
            {
                this.cancellationTokenSource.Cancel();
                ToastNotification.Show(this, "실행 중지 중...", 1000, eToastPosition.TopCenter);
            }
        }
        ...
        private bool SaveFile(FrmLuaEditor editor, bool saveAs = false)
        {
            ...
            this.env.WriteLine($"===={editor.FileName} 저장 완료====");
            return true;
        }
        ...
        private void OpenFile(string fileName)
        {
            ...
            {
                MessageBoxEx.Show(this, ex.ToString(), "오류", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void FrmLuaEditor_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                switch(MessageBoxEx.Show(this, "창을 닫으면 저장하지 않은 변경 내용이 사라집니다. 저장하시겠습니까？", "경고", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning))
                {
